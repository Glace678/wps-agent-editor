...
apply('aiden0z-pptx-renderer.cjs', [
  ...
  },
  {
    ...
    to: `tabSizeEmu=tabDefTabSz!==void 0&&tabDefTabSz!==914400?tabDefTabSz:F*r*25400;break}}if(tabSizeEmu===null)tabSizeEmu=F*r*25400`,
  },
  {
    label: 'migrate tab grid offset formula',
    optional: true,
