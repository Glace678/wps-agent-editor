...
test('heading-styles FormattingDropdown wires heading contentClassName', () => {
  ...
  assert.match(headingBlock[0], /contentClassName=\{headingFormatContentClass\}/)
})
...
test('heading and list menus still expose all expected format commands', () => {
  ...
  for (const cmd of ['bullet-list', 'number-list']) {
