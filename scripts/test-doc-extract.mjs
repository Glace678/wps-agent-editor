...
const p = path.join(process.env.USERPROFILE, 'Desktop', 'B24040418欧寅圣实验一.doc')
...
fs.writeFileSync(path.join(process.env.USERPROFILE, 'Desktop', '_doc_compat_test.docx'), docx)
console.log('wrote _doc_compat_test.docx')
