export const IPC = {
  ...
  FILE_NAVIGATE_BACK: 'file:navigate-back',

  // OnlyOffice
  OO_GET_CONFIG: 'onlyoffice:get-config',
  OO_FORCE_SAVE: 'onlyoffice:force-save',
  OO_AGENT_EDIT: 'onlyoffice:agent-edit',
  OO_AGENT_RESULT: 'onlyoffice:agent-result',
  OO_AGENT_CANCEL: 'oo:agent-cancel',
  ...
  AGENT_EVENT: 'agent:collaboration-event',
  AGENT_DOCUMENT_ACTIVITY: 'agent:document-activity',
  AGENT_APPROVAL_RESPONSE: 'agent:approval-response',
  AGENT_PLAYBACK_CONTROL: 'agent:playback-control',

  // Transactional document artifact review
  ARTIFACT_DRAFT_CREATE: 'artifact:draft-create',
  ARTIFACT_DRAFT_CREATE_BATCH: 'artifact:draft-create-batch',
  ARTIFACT_DRAFT_GET: 'artifact:draft-get',
  ARTIFACT_DRAFT_FIND: 'artifact:draft-find',
  ARTIFACT_DRAFT_PAYLOAD: 'artifact:draft-payload',
  ARTIFACT_REVIEW_COMMAND: 'artifact:review-command',
  ARTIFACT_REVIEW_EVENT: 'artifact:review-event',
  ARTIFACT_HISTORY_LIST: 'artifact:history-list',
  ARTIFACT_HISTORY_READ: 'artifact:history-read',
  ARTIFACT_HISTORY_REOPEN: 'artifact:history-reopen',
  ARTIFACT_PRODUCER_CAPABILITIES: 'artifact:producer-capabilities',
  ARTIFACT_PRODUCER_STAGE: 'artifact:producer-stage',
  ARTIFACT_SOURCE_STAGE: 'artifact:source-stage',
  ARTIFACT_STAGE_RELEASE: 'artifact:stage-release',
  ARTIFACT_PRODUCER_REBUILD: 'artifact:producer-rebuild',
  ARTIFACT_PRODUCER_RESULT: 'artifact:producer-result',
  ARTIFACT_E2E_CREATE: 'artifact:e2e-create',
  CODE_WORKSPACE_INSPECT: 'code-artifact:workspace-inspect',
  CODE_ARTIFACT_READ: 'code-artifact:read',
  CODE_ARTIFACT_RESOLVE: 'code-artifact:resolve',
  ...
  LW_AGENT_CANCEL: 'lw:agent-cancel',
  LW_AGENT_EVENT: 'lw:agent-event',
  LW_WORD_PLAYBACK_CONTROL: 'lw:word-playback-control',
