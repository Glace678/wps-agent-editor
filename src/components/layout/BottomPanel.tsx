...
export function BottomPanel() {
  ...
  return (
    <TooltipProvider delayDuration={450}>
      <div
        className="flex shrink-0 flex-col border-t bg-[#fafafa] text-[#1f2328] dark:bg-[#121418] dark:text-[#dfe3e8]"
        style={{ height }}
        data-testid="bottom-panel"
      >
        <div
          className="h-[5px] shrink-0 cursor-ns-resize bg-transparent hover:bg-primary/40 active:bg-primary/60"
          onMouseDown={(event) => {
            ...
            return (
              <button
                ...
                className={`flex h-full items-center gap-1.5 border-b-2 px-2 text-xs transition-colors ${
                  active
                    ? 'border-primary bg-black/[0.04] font-medium text-foreground dark:bg-white/[0.06]'
