  ...
  return (
    <Tooltip>
      ...
      <TooltipContent
        side="bottom"
        sideOffset={7}
        className="whitespace-nowrap rounded-xl border border-[#7a7a7a] bg-[#555] px-3.5 py-1.5 text-center text-[15px] font-medium leading-normal text-white shadow-md"
